	...
	function s(o, u) {
		...
		(function (process, global, Buffer, __argument0, __argument1, __argument2, __argument3, __filename, __dirname) {
			...
			(0, _jquery2.default)('document').ready(function () {
				(0, _jquery2.default)('.hamburger').click(function (e) {
					e.currentTarget.classList.toggle('is-active');
					(0, _jquery2.default)('#navbar').toggleClass('is-active');
				});
				(0, _jquery2.default)('.testimonial__carousel').slick({
					dots: true,
					infinite: true,
					speed: 500,
					fade: true,
				...
				(0, _jquery2.default)('.instagram__carousel').slick({
					dots: false,
					infinite: true,
					speed: 300,
					slidesToShow: 4,
				...
				(0, _jquery2.default)('.mini-testimonial__carousel').slick({
					dots: true,
					infinite: true,
					speed: 500,
					fade: true,
				...
				if ((0, _jquery2.default)('.scrolldown').length > 0) {
					(0, _jquery2.default)('.scrolldown').click(function () {
						(0, _jquery2.default)('html, body').animate({
							scrollTop: (0, _jquery2.default)('.hero').next('section').offset().top - 85
						}, 2000);
					});
				}
				...
				(0, _jquery2.default)(window).scroll(function () {
					...
					if (viewportWidth > 767) {
						if (scroll > 1) {
							(0, _jquery2.default)('.navbar-inverse').addClass('navbar-active');
						} else {
							(0, _jquery2.default)('.navbar-inverse').removeClass('navbar-active');
						}
					}
				});

				//redirect to contact page when filling out mini form
				if ((0, _jquery2.default)('.get-in-touch--mini form').length > 0) {
					(0, _jquery2.default)('.get-in-touch--mini form').on('submit', function (e) {
						e.preventDefault();
						var form = (0, _jquery2.default)('#mini-contact').serialize();
				...
				// contact page form population
				if ((0, _jquery2.default)('.page-template-page-contact').length > 0) {
					var queryParams = parseQuery(window.location.search);
					setTimeout(function () {
						(0, _jquery2.default)('#nf-field-1').val(queryParams.user_name);
						(0, _jquery2.default)('#nf-field-2').val(queryParams.user_email);
					}, 1000);
				}
			});
		}).call(this, require("yqZKBy"), typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {}, require("buffer").Buffer, arguments[3], arguments[4], arguments[5], arguments[6], "/fake_d84e5576.js", "/");
	}, { "buffer": 3, "jquery": 6, "slick-carousel": 7, "yqZKBy": 4 }], 2: [function (require, module, exports) {
		(function (process, global, Buffer, __argument0, __argument1, __argument2, __argument3, __filename, __dirname) {
